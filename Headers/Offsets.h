...
namespace offsets {
constexpr std::ptrdiff_t EntityList = 0x1D15F88;
constexpr std::ptrdiff_t LocalPlayerPawn = 0x1BF2490;
constexpr std::ptrdiff_t ViewMatrix = 0x1E330F0;
...
constexpr std::ptrdiff_t m_hPawn =
    0x6B4;  // CHandle<C_BasePlayerPawn :o - lol phil >
