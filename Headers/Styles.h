...
class Styles {
 public:
  static void Apply() {
    ...
    style.Colors[ImGuiCol_WindowBg] = ImColor(9, 17, 27, 15);  // primtv 3
    style.Colors[ImGuiCol_ChildBg] =
        ImColor(0.031f, 0.066f, 0.10f, 1.0f);                   // primtv 1
    ...
    style.Colors[ImGuiCol_ScrollbarGrab] =
        ImColor(20, 148, 20, 100);  // accent 3
